...
int main() {
	...
	for (i = 0; i < arraySize1; i++) printf("%d ", array1[i]);			//перестановка элементов по возрастанию
	printf("\nSorted second array: ");
	bubble(array2, arraySize2);
	for (i = 0; i < arraySize2; i++) printf("%d ", array2[i]);			//перестановка элементов по возрастанию
